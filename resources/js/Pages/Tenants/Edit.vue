...
<template>
  ...
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8 font-inter">
    <!-- Header -->
      ...
      <form @submit.prevent="submit" class="space-y-8">
        ...
        <div class="space-y-6">
          ...
          <div class="relative">
            ...
            <div v-if="form.errors.name" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
          ...
          <div class="relative">
            ...
            <div v-if="form.errors.email" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              {{ form.errors.email }}
          ...
          <div class="relative">
            ...
            <div v-if="form.errors.cnpj" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              {{ form.errors.cnpj }}
          ...
          <div class="relative">
            ...
            <div class="mt-1 relative">
              <input
                ...
                placeholder="Digite o domínio (ex: empresa)"
              />
              <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-if="form.errors.domain" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              {{ form.errors.domain }}
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="relative">
              ...
              />
              <div v-if="form.errors.street" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {{ form.errors.street }}
            ...
            <div class="relative">
              ...
              />
              <div v-if="form.errors.number" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {{ form.errors.number }}
          ...
          <div class="relative">
            ...
            />
            <div v-if="form.errors.complement" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="relative">
              ...
              />
              <div v-if="form.errors.city" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {{ form.errors.city }}
            ...
            <div class="relative">
              ...
              <input
                ...
                maxlength="2"
              />
              <div v-if="form.errors.state" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {{ form.errors.state }}
          ...
          <div class="relative">
            ...
            <div v-if="form.errors.postal_code" class="text-red-500 text-sm mt-1 flex items-center animate-fade-in">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
