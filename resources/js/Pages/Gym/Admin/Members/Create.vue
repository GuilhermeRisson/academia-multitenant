...
// Instale o pacote v-mask se quiser usar máscaras: npm install vue-the-mask
...
const form = useForm({
  ...
  postal_code: '',
  active: true,
  registration_date: new Date().toISOString().split('T')[0], // Data atual como padrão
  notes: '',
});
...
<template>
  ...
  <div class="min-h-screen bg-gray-50 p-6">
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8">
      <h1 class="text-2xl font-bold text-gray-900 mb-6">Criar Novo Membro</h1>
