  ...
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-gray-50 to-gray-100 text-gray-900 font-inter">
    ...
    <section id="classes" class="py-16 bg-white">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div class="group text-center p-6 bg-gray-50 rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            <img src="/images/yoga-class.jpg" alt="Yoga" class="w-full h-48 object-cover rounded-md mb-4" />
            <h4 class="text-xl font-semibold mb-2 text-indigo-600">Yoga</h4>
            <p class="text-gray-600">Relaxe e fortaleça seu corpo com nossas aulas de yoga guiadas por instrutores experientes.</p>
          </div>
          <div class="group text-center p-6 bg-gray-50 rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            <img src="/images/crossfit-class.jpg" alt="CrossFit" class="w-full h-48 object-cover rounded-md mb-4" />
          ...
          <div class="group text-center p-6 bg-gray-50 rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            <img src="/images/spinning-class.jpg" alt="Spinning" class="w-full h-48 object-cover rounded-md mb-4" />
    ...
    <section id="plans" class="py-16 bg-gray-100">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div class="group bg-white p-6 rounded-xl shadow-lg text-center transform hover:scale-105 transition duration-300">
            <h4 class="text-xl font-semibold mb-2 text-indigo-600">Básico</h4>
            <p class="text-3xl font-bold mb-4 text-gray-800">R$99/mês</p>
            <ul class="text-left mb-6 text-gray-600">
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Acesso a equipamentos</li>
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Aulas em grupo</li>
            </ul>
            <Link
              href="#signup"
          ...
          <div class="group bg-white p-6 rounded-xl shadow-lg text-center border-2 border-indigo-600 transform hover:scale-105 transition duration-300">
            <h4 class="text-xl font-semibold mb-2 text-indigo-600">Premium</h4>
            <p class="text-3xl font-bold mb-4 text-gray-800">R$149/mês</p>
            <ul class="text-left mb-6 text-gray-600">
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Tudo do plano Básico</li>
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Personal trainer</li>
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Aulas exclusivas</li>
            </ul>
            <Link
              href="#signup"
              class="inline-block bg-indigo-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition duration-300"
          ...
          <div class="group bg-white p-6 rounded-xl shadow-lg text-center transform hover:scale-105 transition duration-300">
            <h4 class="text-xl font-semibold mb-2 text-indigo-600">Familiar</h4>
            <p class="text-3xl font-bold mb-4 text-gray-800">R$249/mês</p>
            <ul class="text-left mb-6 text-gray-600">
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Até 3 membros</li>
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Tudo do plano Premium</li>
              <li class="flex items-center"><svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg> Descontos em eventos</li>
            </ul>
            <Link
              href="#signup"
              class="inline-block bg-indigo-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition duration-300"
      ...
      <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <form @submit.prevent="submitContact" class="max-w-lg mx-auto space-y-4">
          ...
          <div class="relative">
            ...
            ></textarea>
            <div v-if="form.errors.message" class="text-red-500 text-sm mt-1 animate-fade-in">{{ form.errors.message }}</div>
          </div>
          <button
            type="submit"
      ...
      <div class="max-w-7xl mx-auto px-6 text-center">
        <div class="flex justify-center space-x-6 mb-4">
          <a href="#" class="text-white hover:text-indigo-200">
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.04c-5.5 0-9.96 4.46-9.96 9.96 0 4.41 3.58 8.06 8.23 8.85v-6.27h-2.48v-2.58h2.48v-1.97c0-2.45 1.49-3.78 3.67-3.78 1.04 0 1.94.08 2.2.11v2.55h-1.51c-1.18 0-1.41.56-1.41 1.38v1.81h2.82l-.37 2.58h-2.45v6.27c4.65-.79 8.23-4.44 8.23-8.85 0-5.5-4.46-9.96-9.96-9.96z"/></svg>
          </a>
          <a href="#" class="text-white hover:text-indigo-200">
